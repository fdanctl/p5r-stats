...
// });
// //
// // const activCards = document.getElementsByClassName("activity-card");
// //
...
// // };
// //
// // for (let i = 0; i < activCards.length; i++) {
// //   activCards[i].addEventListener("click", async (event) => {
// //     const res = await getActivityById(event.target.dataset.id);
// //     console.log(res);
// //     const form = document.querySelector("#add-activity form");
// //     form.querySelector("input").value = res.title;
// //     form.querySelector("textarea").value = res.description;
// //   });
// // }
